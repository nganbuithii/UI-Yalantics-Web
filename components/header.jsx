...
export default function Header() {
    ...
    return (
        <header
            className={`transition-colors duration-300 ease-in-out fixed top-0 left-0 w-full z-50  lg:shadow-none ${isScrolled ? 'main-bg' : 'transparent'
        ...
        >
            <div className="flex flex-row justify-around items-center h-16">
                <div className="w-[15%] xl:w-[10%]  flex-shrink-0 flex items-center justify-center">
                    <Link href="/home">
                        <Image
                            ...
                            width={130}
                            height={130}
                            className="object-contain xl:w-[90px]  "
                        />
                    </Link>
                </div>
                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    lg:hidden
                     ">
                        ...
                        <Link href="/expertise" className=" xl:text-base  link text-white px-4 py-2 rounded-md text-lg font-semibold transition duration-300 ease-in-out">
                            EXPERTISE
                        </Link>
                        <Link href="/industries" className=" xl:text-base  link text-white px-4 py-2 rounded-md text-lg font-semibold transition duration-300 ease-in-out">
                            INDUSTRIES
                        </Link>
                        <Link href="#" className=" xl:text-base  link text-white px-4 py-2 rounded-md text-lg font-semibold transition duration-300 ease-in-out">
                            SUCCESS STORIES
                        </Link>
                        <Link href="/solution-hub" className=" xl:text-base  link text-white px-4 py-2 rounded-md text-lg font-semibold transition duration-300 ease-in-out">
                            SOLUTION HUB
                        </Link>
                        <Link href="#" className=" xl:text-base  link text-white px-4 py-2 rounded-md text-lg font-semibold transition duration-300 ease-in-out">
                            COMPANY
                ...
                <div className="ml-15 lg:flex flex-row">
                    <div>
                        <Button
                            onClick={handleClick}
                    ...
                    <div>
                        <TiThMenu className='text-5xl ml-10 text-white' />
                    </div>
