...
export default function ItemExpertise({ title }) {
    return (
        <div className="group relative flex flex-row w-full bg-[#2b2d32] pr-[24px] p-4 border-[#494b50] border-b-4 border-transparent hover:border-orange-500 hover:after:animate-border transition duration-300 ease-in-out my-3 px-10 py-6">

            <p className="text-white group-hover:text-orange-600">{title}</p>
