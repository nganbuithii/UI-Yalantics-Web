...
export default function CaseStudies({ title, items = [], className, image }) {
    return (
        <section className={`hover:bg-[url('https://yalantis.com/wp-content/uploads/2024/03/oxygen.webp')]  group bg-no-repeat bg-center relative border border-orange-100 px-10 py-6 sm:mx-3 xl:mx-0 lg:mx-0 md:mx-0 ${className}`}>
