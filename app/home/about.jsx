        ...
        <>
            <section className=" py-12 pt-40 xl:pt-[85px] max-xl:pt-[85px] ">
                <div className="flex flex-row">
                    <h1 className="2xl:text-6xl text-orange-600 pb-11 pl-8 xl:text-[56px] max-xl:text-[56px]
                    md:text-[46px] sm:text-[18px] sm:pb-1">About
                    </h1>

                    <h1 className="2xl:text-6xl text-black pb-11 pl-4 xl:text-[56px] max-xl:text-[56px]  md:text-[46px]  sm:text-[18px] sm:pb-1">Us
                    </h1>
                </div>

                <div className="flex flex-row lg:flex-wrap 2xl:flex-nowrap md:flex-wrap sm:flex-wrap">
                    <div className="2xl:w-[70%] p-8 lg:w-full  md:w-full sm:w-full sm:py-0">
                        ...
                        <div className="flex flex-row  sm:flex-col sm:justify-start">
                    ...
                    <div className="2xl:w-[30%] lg:w-full bg-gray-100 p-9 2xl:mr-10 lg:flex lg:flex-col lg:items-center md:w-full md:flex md:flex-col md:items-center sm:w-full sm:mx-3">

                        <div>
                            <p className="text-gray-500 text-2xl  ">Our Office</p>

                            <div className="pb-8  lg:flex-row lg:flex-wrap lg:justify-center lg:flex md:flex md:flex-row md:flex-wrap md:pt-10  2xl:flex-wrap">
                                <div className="lg:w-1/2 md:w-1/2   2xl:w-full flex flex-row pb-8">
