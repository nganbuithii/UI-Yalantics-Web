    ...
    return (
        <section className="relative main-bg lg:pb-20 ">
            <div className="flex flex-row pt-20 pl-8 pb-12  md:items-between">
                ...
                <div className="flex flex-row ml-auto 2xl:space-x-4 md:space-x-0 pr-10 md:absolute md:right-0 md:top-1/2 md:flex md:pl-3
                md:flex-col
                2xl: absolute 2xl:top-10 2xl:flex-row sm:hidden
                ">
            ...
            <Swiper
                ...
                modules={[Navigation]}
                className="flex flex-row case-studies lg:w-[80%] lg:justify-normal lg:pb-20 md:w-[80%] ml-auto md:justify-start md:ml-[10px] 2xl:w-full 2xl:ml-3 "
                breakpoints={{
